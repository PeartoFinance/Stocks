        ...
        {!selectedArticle ? (
          <>
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <h1 className="text-3xl font-bold text-gray-900 mb-4">ETF News & Analysis</h1>
              <p className="text-gray-600">Stay updated with the latest developments in the ETF market</p>
            </motion.div>
              ...
              <div className="p-8">
                ...
                <div className="flex items-center space-x-4 mb-8 pb-8 border-b border-gray-200">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{selectedArticle.source}</p>
                  </div>
                </div>

                <div className="prose prose-lg max-w-none">
                  <p className="text-xl text-gray-600 mb-8">{selectedArticle.summary}</p>
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="text-sm font-medium text-gray-700">Related ETFs:</span>
