      ...
      <main className="p-4 lg:p-6">
        <div className="max-w-[1600px] mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-4">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-[#fafafa] mb-1">Stock Comparison</h1>
            <p className="text-sm text-gray-600 dark:text-[#a3a3a3]">Compare up to 5 stocks side by side</p>
          </motion.div>

          {/* Search Section */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white dark:bg-[#171717] rounded-lg p-4 border border-gray-200 dark:border-[#262626] mb-6">
            <div className="flex items-center justify-between mb-3">
              <h2 className="text-sm font-semibold text-gray-900 dark:text-[#fafafa]">Add Stocks</h2>
            ...
            <div className="relative mb-3">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 text-sm border border-gray-300 dark:border-[#262626] rounded-lg bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-[#fafafa] focus:ring-2 focus:ring-blue-500 dark:focus:ring-emerald-500"
              />
            ...
            {searchResults.length > 0 && (
              <div className="border border-gray-200 dark:border-[#262626] rounded-lg max-h-48 overflow-y-auto">
                {searchResults.map((stock) => (
                  <div key={stock.symbol} className="flex items-center justify-between p-3 hover:bg-gray-50 dark:hover:bg-[#1a1a1a] border-b border-gray-100 dark:border-[#262626] last:border-b-0">
                    <div className="flex-1">
                      <h4 className="text-sm font-semibold text-gray-900 dark:text-[#fafafa]">{stock.symbol}</h4>
            ...
            {searchTerm === '' && comparedStocks.length < 5 && (
              <div>
                <h4 className="text-xs font-medium text-gray-700 dark:text-[#a3a3a3] mb-2">Popular Stocks</h4>
                <div className="flex flex-wrap gap-2">
                  {['AAPL', 'MSFT', 'GOOGL', 'AMZN', 'TSLA', 'NVDA'].map((symbol) => (
                    <button
                      ...
                      className="px-3 py-1 text-xs font-medium bg-gray-100 dark:bg-[#1a1a1a] hover:bg-gray-200 dark:hover:bg-[#262626] disabled:opacity-50 text-gray-700 dark:text-[#fafafa] rounded-md"
                    >
                      {symbol}
                    </button>
                  ))}
          ...
          {comparedStocks.length > 0 && (
            <>
              <div className="bg-white dark:bg-[#171717] rounded-lg p-1 border border-gray-200 dark:border-[#262626] mb-6">
