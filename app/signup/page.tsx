            ...
            <div className="relative z-10 w-full max-w-sm px-6 text-center">
                ...
                <div className="mb-8 flex justify-center">
                    <div className="relative">
                        ...
                        <div className="absolute -right-2 -bottom-2 bg-white rounded-full p-1.5 shadow-sm border border-gray-50 animate-bounce">
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 text-xs font-semibold text-teal-600 uppercase tracking-widest">
