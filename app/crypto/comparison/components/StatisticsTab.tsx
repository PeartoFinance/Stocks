  ...
  if (comparedCryptos.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-[#fafafa] mb-2">No cryptos to compare</h3>
        <p className="text-sm text-gray-600 dark:text-[#a3a3a3]">Add cryptocurrencies to see detailed statistics</p>
      </div>
    );
  }
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-sm font-bold text-gray-900 dark:text-[#fafafa]">{crypto.symbol}</span>
                      </div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-[#737373] truncate">{crypto.name}</p>
                    </div>
                  );
                })}
              </div>
