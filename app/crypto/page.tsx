      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-6 sm:py-8">
        <div className="flex flex-col xl:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1">
            {/* Search and Filters */}
            <div className="bg-white rounded-xl shadow-lg border border-gray-200/50 p-4 sm:p-6 mb-8">
              <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 items-center justify-between mb-6">
                <div className="w-full lg:w-1/2">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-gray-900 placeholder-gray-500 text-sm sm:text-base"
                    />
                  </div>
                </div>
                ...
                <div className="flex gap-2 sm:gap-3 w-full lg:w-auto">
                  <select
                    ...
                    className="px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white text-gray-900 text-sm sm:text-base w-full sm:w-auto"
                  >
                  ...
                  <table className="w-full min-w-[600px]">
                    ...
                    <tbody className="bg-white divide-y divide-gray-100">
                      {filteredCrypto.map((crypto, index) => (
                        <tr key={crypto.id || crypto.symbol || index} className="hover:bg-emerald-50/50 transition-colors duration-200">
                          ...
                          <td className="px-3 sm:px-6 py-3 sm:py-4 whitespace-nowrap">
                            <div className="flex items-center">
                              ...
                              <div className="ml-2 sm:ml-4">
                                <div className="text-sm font-medium text-gray-900 truncate max-w-[100px] sm:max-w-none">{crypto.name || 'Unknown'}</div>
                                <div className="text-xs sm:text-sm text-gray-500">{crypto.symbol || 'UNKNOWN'}</div>
                              </div>
                            </div>
                          </td>
          ...
          {/* AI Analysis Panel - Sidebar on Desktop, Below on Mobile */}
