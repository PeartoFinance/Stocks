                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    ...
                    <div className="col-span-2 md:col-span-3 lg:col-span-1">
                        <Link href="/" className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-bold text-white">Pearto Stocks</span>
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {footerLinks.markets.map((link) => (
                                <li key={link.href}>
                                    <Link href={link.href} className="text-white/70 hover:text-white text-sm transition">
                                        {link.label}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {footerLinks.company.map((link) => (
                                <li key={link.href}>
                                    <a href={link.href} className="text-white/70 hover:text-white text-sm transition">
                                        {link.label}
                                    </a>
                                </li>
                            ))}
