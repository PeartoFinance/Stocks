  ...
  return (
    <div className="space-y-6">
      ...
      <div className="lg:hidden space-y-3 mb-4">
        ...
        {/* Volume Stats */}
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-3 sm:p-4">
          <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">Volume & Supply</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
        ...
        {/* Key Metrics */}
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-3 sm:p-4">
          <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">Key Metrics</h3>
                    ...
                    {periods.map((p) => (
                      <button
                        ...
                        className={`px-3 py-1.5 text-xs font-medium rounded-md transition-all ${
                          chartPeriod === p ? "bg-emerald-600 text-white shadow-sm" : "text-gray-600 hover:bg-gray-100"
                        }`}
                      >
                        {p}
                      </button>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-4 lg:p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">Overview</h4>
            {crypto.description ? (
          ...
          {/* Crypto Details */}
          <div>
            <h4 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">Details</h4>
            <div className="space-y-2">
              {[
                ...
                item.value && (
                  <div key={i} className="flex justify-between py-1.5 border-b border-slate-100 dark:border-slate-800 last:border-0">
                    ...
                    {item.label === 'Website' && crypto.website ? (
                      <a href={crypto.website} target="_blank" rel="noopener noreferrer" className="text-xs font-medium text-emerald-600 hover:text-emerald-500 flex items-center gap-1">
                        Visit Site
