...
export default function CryptoControls({ 
  ...
  return (
    <div className="bg-white dark:bg-gray-800 dark:bg-pearto-card rounded-xl shadow-sm border border-slate-200 dark:border-gray-700 dark:border-pearto-border p-4 mb-6 transition-colors duration-300">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg font-medium transition-all duration-200 text-sm ${
                selectedTab === 'all'
                  ...
                  : 'text-slate-600 dark:text-gray-400 hover:text-slate-900 dark:text-white hover:bg-gray-100 dark:bg-gray-700'
              }`}
            >
              All
            </button>
          ...
          <div className="flex gap-2 items-center">
            {/* View Mode Toggle */}
            <div className="flex bg-gray-100 dark:bg-gray-700 dark:bg-gray-700 p-1 rounded-lg transition-colors duration-300">
              <button
                onClick={() => onViewModeChange('table')}
                className={`p-2 rounded transition-all ${
                  viewMode === 'table'
                    ? 'bg-white dark:bg-gray-800 text-emerald-600 dark:text-pearto-green shadow-sm'
                    : 'text-gray-500 dark:text-gray-400 hover:text-slate-700 dark:text-gray-400'
                }`}
                title="Table View"
              >
