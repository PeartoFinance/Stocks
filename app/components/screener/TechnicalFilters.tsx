      ...
      <div className="space-y-6">
            ...
            <button
              ...
              className={`px-4 py-3 text-sm font-medium rounded-lg transition-all border ${
                filters.rsiCondition === 'oversold'
                  ...
                  : 'bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-gray-600 hover:border-green-400 dark:hover:border-green-500'
              }`}
            >
              <div className="font-medium">Oversold</div>
            ...
            <button
              ...
              className={`px-4 py-3 text-sm font-medium rounded-lg transition-all border ${
                filters.rsiCondition === 'neutral'
                  ...
                  : 'bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-gray-600 hover:border-blue-400 dark:hover:border-blue-500'
              }`}
            >
            ...
            <button
              ...
              className={`px-4 py-3 text-sm font-medium rounded-lg transition-all border ${
                filters.rsiCondition === 'overbought'
                  ...
                  : 'bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-gray-600 hover:border-red-400 dark:hover:border-red-500'
              }`}
            >
              <div className="font-medium">Overbought</div>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              <div className="font-medium">Death Cross</div>
            ...
            >
              <div className="font-medium">Above 200 MA</div>
            ...
            <button
              ...
              className={`px-4 py-3 text-sm font-medium rounded-lg transition-all border ${
                filters.maCondition === 'below_ma'
                  ...
                  : 'bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-gray-600 hover:border-orange-400 dark:hover:border-orange-500'
              }`}
            >
              <div className="font-medium">Below 200 MA</div>
          ...
          <button
            ...
            className={`w-full px-4 py-3 text-sm font-medium rounded-lg transition-all border ${
              filters.volumeSpike
                ...
                : 'bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-300 border-slate-300 dark:border-gray-600 hover:border-purple-400 dark:hover:border-purple-500'
            }`}
          >
            <div className="font-medium">{filters.volumeSpike ? '✓ ' : ''}Volume Spike Detected</div>
