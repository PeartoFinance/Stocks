...
export default function NewsTab({ symbol, news: initialNews, loading: initialLoading }: NewsTabProps) {
  ...
  const getSentimentColor = (sentiment?: string) => {
    switch (sentiment) {
      ...
      case 'neutral': return 'text-slate-600 dark:text-gray-400 bg-gray-100 dark:bg-slate-900/95/20 dark:text-gray-400';
      default: return 'text-slate-600 dark:text-gray-400 bg-gray-100 dark:bg-slate-900/95/20 dark:text-gray-400';
    }
  };
