...
export default function NewsTab({ symbol, news: initialNews, loading: initialLoading }: NewsTabProps) {
  ...
  const getSentimentColor = (sentiment?: string) => {
    switch (sentiment) {
      ...
      case 'neutral': return 'text-gray-600 bg-gray-100 dark:bg-gray-900/20 dark:text-gray-400';
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-slate-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
          </div>
        </div>
