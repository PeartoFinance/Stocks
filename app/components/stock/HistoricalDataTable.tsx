                ...
                <div className="absolute top-full left-0 mt-1 z-10 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md shadow-lg min-w-[70px] lg:min-w-[80px]">
                  {timeframes.map((tf) => (
                    <button
                      ...
                      className={`w-full px-3 py-1.5 lg:px-4 lg:py-2 text-xs lg:text-sm text-left hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors first:rounded-t-md last:rounded-b-md ${
                        timeframe === tf ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-medium' : 'text-slate-700 dark:text-slate-300'
                      }`}
                    >
                      {tf}
                    </button>
                ...
                <div className="absolute top-full left-0 mt-1 z-10 bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-600 rounded-md shadow-lg min-w-[70px] lg:min-w-[80px]">
                  {periods.map((p) => (
                    <button
                      ...
                      className={`w-full px-3 py-1.5 lg:px-4 lg:py-2 text-xs lg:text-sm text-left hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors first:rounded-t-md last:rounded-b-md ${
                        period === p ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-medium' : 'text-slate-700 dark:text-slate-300'
                      }`}
                    >
                      {p}
                    </button>
              ...
              return (
                <tr key={index} className="hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
                  ...
                  <td className="px-2 lg:px-4 lg:px-5 py-2 lg:py-3 text-xs lg:text-sm">
                    {change ? (
                      <div className={`flex items-center gap-0.5 lg:gap-1 font-medium ${
                        ...
                        <span className="hidden sm:inline">{change.formatted}</span>
