      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
            ...
            {showSearch && (
              <div className="relative ml-8">
                ...
                <input
                  ...
                  className="w-96 pl-12 pr-4 py-3 border border-gray-300 dark:border-pearto-border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-gray-50  focus:bg-white dark:bg-pearto-card transition-colors"
                />
          ...
          <div className="flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-3">
              <button className="p-2 text-gray-600  hover:text-gray-900 dark:text-pearto-luna hover:bg-gray-100 dark:bg-pearto-surface rounded-lg transition-colors">
                <Bell className="h-5 w-5" />
              </button>
              <button className="text-gray-600  hover:text-gray-900 dark:text-pearto-luna text-sm font-medium px-3 py-2 rounded-lg hover:bg-gray-100 dark:bg-pearto-surface transition-colors">
                Log Out
              </button>
