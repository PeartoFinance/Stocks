      ...
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-4 sm:p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-medium text-slate-900 dark:text-white">Top Gainers</h2>
              <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">Stocks with the highest gains today</p>
            </div>
          </div>
          <button
            onClick={refreshData}
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="hidden lg:block">
              <div className="px-4 py-3 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 flex items-center justify-between">
                <h3 className="font-semibold text-slate-900 dark:text-white">Top Gainers</h3>
