            ...
            <div className="block lg:hidden overflow-x-auto">
              <table className="w-full min-w-[600px] text-sm">
                <thead className="bg-gradient-to-r from-green-50 via-emerald-50 to-green-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-700 border-b-2 border-green-200 dark:border-gray-600">
                  <tr>
                    <th className="px-3 py-3 text-left text-xs font-semibold text-green-700 dark:text-green-400 uppercase tracking-wider">Stock</th>
                    <th className="px-3 py-3 text-right text-xs font-semibold text-green-700 dark:text-green-400 uppercase tracking-wider">Price</th>
                    <th className="px-3 py-3 text-right text-xs font-semibold text-green-700 dark:text-green-400 uppercase tracking-wider">Change</th>
                    <th className="px-3 py-3 text-right text-xs font-semibold text-green-700 dark:text-green-400 uppercase tracking-wider">Volume</th>
                    <th className="px-3 py-3 text-right text-xs font-semibold text-green-700 dark:text-green-400 uppercase tracking-wider">MCap</th>
                  </tr>
                </thead>
