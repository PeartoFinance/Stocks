      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Top Gainers</h2>
              <p className="text-sm text-gray-600 mt-1">Stocks with the highest gains today</p>
            </div>
          </div>
          <button
            onClick={refreshData}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        {isLoading ? (
          ...
          <div className="text-center py-12 sm:py-16">
            <p className="text-gray-500">No gainers data available at the moment.</p>
          </div>
        ) : (
          <>
            {/* Mobile View */}
