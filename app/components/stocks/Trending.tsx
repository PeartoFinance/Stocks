      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Trending Stocks</h2>
              <p className="text-sm text-gray-600 mt-1">Most talked about and actively traded stocks</p>
            </div>
          </div>
          <button
            onClick={refreshData}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        {isLoading ? (
          ...
          <div className="text-center py-12 sm:py-16">
            <p className="text-gray-500">No trending stocks data available at the moment.</p>
          </div>
        ) : (
          <>
            {/* Mobile View */}
                  ...
                  <Link href={`/stock/${stock.symbol.toLowerCase()}`}>
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-right">
                        ...
                        <div className={stock.change >= 0 ? 'text-green-600 font-medium' : 'text-red-600 font-medium'}>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 text-sm">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Trending</th>
                      ...
                      >
                        ...
                        <td className="px-4 py-2 whitespace-nowrap">
                          ...
                          <Link href={`/stock/${stock.symbol.toLowerCase()}`} className="group block">
                            <div className="flex flex-col items-start">
                              <div className="text-sm font-bold text-gray-900 group-hover:text-purple-600 transition-colors leading-tight">
                                {stock.symbol}
                              </div>
                              <div className="text-xs text-gray-500 truncate max-w-[160px] leading-tight mt-0.5">
                                {stock.name}
                              </div>
                            </div>
                          </Link>
                        ...
                        <td className="px-4 py-2 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <div className={`text-sm ml-2 ${stock.change >= 0 ? 'text-green-600' : 'text-red-600'}`}>
