      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-4 sm:p-6 transition-colors duration-300">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-medium text-slate-900 dark:text-white transition-colors duration-300">Top Losers</h2>
              <p className="text-sm text-slate-600 dark:text-slate-400 mt-1 transition-colors duration-300">Stocks with the biggest declines today</p>
            </div>
          </div>
          <button
            onClick={refreshData}
          ...
          <>
            ...
            <div className="block lg:hidden overflow-x-auto">
              <table className="w-full min-w-[600px] text-sm">
                <thead className="bg-gradient-to-r from-red-50 via-rose-50 to-red-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-700 border-b-2 border-red-200 dark:border-gray-600">
                  <tr>
                    <th className="px-3 py-3 text-left text-xs font-semibold text-red-700 dark:text-red-400 uppercase tracking-wider">Stock</th>
                    <th className="px-3 py-3 text-right text-xs font-semibold text-red-700 dark:text-red-400 uppercase tracking-wider">Price</th>
                    <th className="px-3 py-3 text-right text-xs font-semibold text-red-700 dark:text-red-400 uppercase tracking-wider">Change</th>
                    <th className="px-3 py-3 text-right text-xs font-semibold text-red-700 dark:text-red-400 uppercase tracking-wider">Volume</th>
                    <th className="px-3 py-3 text-right text-xs font-semibold text-red-700 dark:text-red-400 uppercase tracking-wider">MCap</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-gray-700">
                  {losers.map((stock) => (
                    <tr key={stock.symbol} className="hover:bg-red-50/50 dark:hover:bg-gray-700/50">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-pearto-border text-sm">
                  <thead className="bg-slate-50 dark:bg-slate-800 transition-colors duration-300">
                    <tr>
                      <th className="px-4 py-2 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider transition-colors duration-300">Rank</th>
                      <th className="px-4 py-2 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider transition-colors duration-300">Stock</th>
                      <th className="px-4 py-2 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider transition-colors duration-300">Price</th>
                      <th className="px-4 py-2 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider transition-colors duration-300">Change</th>
                      <th className="px-4 py-2 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider transition-colors duration-300">Volume</th>
                      <th className="px-4 py-2 text-left text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider transition-colors duration-300">Market Cap</th>
                      <th className="px-4 py-2 text-center text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider transition-colors duration-300">Sector</th>
                    </tr>
                  </thead>
                        ...
                        <td className="px-4 py-2 whitespace-nowrap">
                          <Link href={`/stock/${stock.symbol.toLowerCase()}`} className="block">
                            <div className="text-center">
                              ...
                              <div className="text-sm text-slate-500 dark:text-slate-400 truncate max-w-[180px] mx-auto transition-colors duration-300">{stock.name}</div>
                            </div>
                          </Link>
                        </td>
                        <td className="px-4 py-2 whitespace-nowrap">
