            ...
            <div className="block lg:hidden overflow-x-auto">
              <table className="w-full min-w-[600px] text-sm">
                <thead className="bg-gradient-to-r from-red-50 via-rose-50 to-red-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-700 border-b-2 border-red-200 dark:border-gray-600">
                  <tr>
                    <th className="px-3 py-3 text-left text-xs font-medium text-red-700 dark:text-red-400 uppercase">Stock</th>
                    <th className="px-3 py-3 text-right text-xs font-medium text-red-700 dark:text-red-400 uppercase">Price</th>
                    <th className="px-3 py-3 text-right text-xs font-medium text-red-700 dark:text-red-400 uppercase">Change</th>
                    <th className="px-3 py-3 text-right text-xs font-medium text-red-700 dark:text-red-400 uppercase">Volume</th>
                    <th className="px-3 py-3 text-right text-xs font-medium text-red-700 dark:text-red-400 uppercase">MCap</th>
                  </tr>
                </thead>
