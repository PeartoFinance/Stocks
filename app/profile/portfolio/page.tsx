                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-2">
                                <PieChart className="h-6 w-6 sm:h-7 sm:w-7 text-white dark:text-white" />
                                <h1 className="text-xl sm:text-2xl font-bold text-white dark:text-white">Portfolio</h1>
                            </div>
                        </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8">
                ...
                {portfolios.length > 0 && (
                    <div className="mb-6 sm:mb-8">
                        <div className="flex flex-col gap-4">
                            <div>
                                <h2 className="text-xl sm:text-2xl font-semibold text-slate-900 dark:text-white mb-2">Portfolio View</h2>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                                <select
                                    ...
                                    className="w-full sm:w-auto px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none bg-white dark:bg-slate-700 text-slate-900 dark:text-white sm:min-w-[250px] text-base"
                                >
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
                    <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 dark:border-slate-700">
                        <div className="flex items-center gap-2 mb-3">
                            <div className="p-2 sm:p-2 rounded-lg bg-blue-100 dark:bg-blue-500/20">
                                <DollarSign className="h-5 w-5 sm:h-5 sm:w-5 text-blue-600 dark:text-blue-400" />
                            </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 dark:border-slate-700">
                        <div className="flex items-center gap-2 mb-3">
                            <div className="p-2 sm:p-2 rounded-lg bg-emerald-100 dark:bg-emerald-500/20">
                                <TrendingUp className="h-5 w-5 sm:h-5 sm:w-5 text-emerald-600 dark:text-emerald-400" />
                            </div>
                            <span className="text-sm sm:text-sm text-slate-500 dark:text-slate-400 font-medium">Total Gain</span>
                        </div>
                        <div
                            className={`text-xl sm:text-3xl font-bold flex flex-col gap-1 ${
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 dark:border-slate-700">
                        <div className="flex items-center gap-2 mb-3">
                            <div className="p-2 sm:p-2 rounded-lg bg-purple-100 dark:bg-purple-500/20">
                                <PieChart className="h-5 w-5 sm:h-5 sm:w-5 text-purple-600 dark:text-purple-400" />
                            </div>
                            <span className="text-sm sm:text-sm text-slate-500 dark:text-slate-400 font-medium">Portfolios</span>
                        </div>
                        <div className="text-xl sm:text-3xl font-bold text-slate-900 dark:text-white">{portfolios.length}</div>
                    </div>
                    <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm border border-slate-100 dark:border-slate-700">
                        <div className="flex items-center gap-2 mb-3">
                            <div className="p-2 sm:p-2 rounded-lg bg-amber-100 dark:bg-amber-500/20">
                                <BarChart3 className="h-5 w-5 sm:h-5 sm:w-5 text-amber-600 dark:text-amber-400" />
                            </div>
                            <span className="text-sm sm:text-sm text-slate-500 dark:text-slate-400 font-medium">Holdings</span>
                        </div>
                        <div className="text-xl sm:text-3xl font-bold text-slate-900 dark:text-white">{filteredHoldings.length}</div>
                    </div>
                </div>
                ...
                {showAddHolding && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 dark:bg-black/70">
                        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto p-4 sm:p-6">
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Portfolio</label>
                                    <select
                                        ...
                                        className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none bg-white dark:bg-slate-700 text-slate-900 dark:text-white"
                                    >
                                        {portfolios.map((p) => (
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        <div className="flex-1 relative">
                                            <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400 dark:text-slate-400" />
                                            <input
                                                type="text"
                                                value={searchQuery}
                                                ...
                                                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none bg-white dark:bg-slate-700 text-slate-900 dark:text-white"
                                            />
                                        </div>
                                        
                                        {/* Stock Suggestions Dropdown */}
                                        {showSuggestions && filteredStocks.length > 0 && (
                                            <div className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl shadow-lg z-10 max-h-64 overflow-y-auto">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Shares</label>
                                        <input
                                            type="number"
                                            step="0.0001"
                                            min="0"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1.5">Avg cost ($)</label>
                                        <input
                                            type="number"
                                            step="0.01"
                                            min="0"
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="flex-1 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-medium disabled:opacity-50"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-medium"
                                    >
                                        Cancel
                                    </button>
                                </div>
                ...
                {showCreatePortfolio && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 dark:bg-black/70">
                        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl max-w-sm w-full p-4 sm:p-6">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-600 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 outline-none bg-white dark:bg-slate-700 text-slate-900 dark:text-white mb-4"
                            />
                            <div className="flex gap-2">
                                <button
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
                    <div className="px-4 sm:px-6 py-4 border-b border-slate-100 dark:border-slate-700">
                        <div className="flex items-center justify-between gap-2">
                            <h2 className="font-semibold text-slate-900 dark:text-white text-xl sm:text-2xl">Holdings</h2>
                            <div className="flex items-center gap-2">
                                <button
                                    onClick={() => {
                                    ...
                                    className="px-3 sm:px-4 py-2 rounded-xl bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-medium transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 text-sm whitespace-nowrap"
                                >
                    ...
                    {loading ? (
                        ...
                        <div className="p-4 lg:p-6 sm:p-12 text-center">
                            ...
                            <div className="flex flex-wrap justify-center gap-2">
                                <button
                                    onClick={() => setShowCreatePortfolio(true)}
                                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-medium transition"
                                >
                                    <Plus className="h-5 w-5" />
                                    Create portfolio
                                </button>
