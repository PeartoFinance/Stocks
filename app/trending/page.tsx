      ...
      <div className="bg-white dark:bg-gray-800 border-b border-slate-200 dark:border-gray-700 shadow-sm transition-colors duration-300">
        <div className="px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white transition-colors duration-300">
                Trending Markets
              </h1>
              <p className="text-sm text-slate-600 dark:text-gray-400 mt-1 transition-colors duration-300">
                Discover the most talked about and actively traded assets
              </p>
            </div>
            
            {/* Toggle Buttons */}
            <div className="flex bg-slate-100 dark:bg-gray-700 rounded-lg p-1 transition-colors duration-300">
              <button
