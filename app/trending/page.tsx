...
export default function TrendingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900/95 transition-colors duration-300">
      {/* Header with Toggle */}
      <div className="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shadow-sm transition-colors duration-300">
        <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            ...
            {/* Toggle Buttons */}
            <div className="flex bg-slate-100 dark:bg-slate-700 rounded-lg p-1 transition-colors duration-300 w-full sm:w-auto">
              <button
